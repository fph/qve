function make_time_test3(experiment,lambdas)
iters=[];
times=[];
tries1=100;
tries2=100;
...
for lambda=lambdas
    ...
    tic;
    for k=1:tries2
        [x2 res2 iter2]=perron_iteration_newnorm_eig(a,b,1.e-13,1e10);
    end
    time2=toc;
    
    for k=1:tries3
        [x3 res3 iter3]=perron_iteration_newnorm_eig(a,b,1.e-13,1e10);
    end
    time3=toc;
